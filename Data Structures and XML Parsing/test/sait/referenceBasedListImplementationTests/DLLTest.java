 ...
 * MyArrayListTest
 */
package referenceBasedListImplementationTests;
...
import referenceBasedListImplementation.*;
...
public class DLLTest
{
	...
	public void testAddAll_ForItemsAddedCorrectly1()
	{
		...
		assertEquals("Elements not added to the end of the list correctly ",
							expected,actual);
		assertEquals("Size was not updated correctly ", 5,myList.size());
	}
	...
	public void testContains_ForFalse()
	{
		...
		assertEquals("Element found in current list and should not have been ",
							expected,actual);
	}
	...
	public void testGetInt1()
	{
		...
		Integer value = myList.get(2);
		int actual = value.intValue();
		assertEquals("Correct item was not retrieved from list ",
							expected,actual);
		assertEquals("Size was not updated correctly ", 4,myList.size());
	}
	...
	public void testIsEmpty_ForFalse()
	{
		...
		boolean expected = false;
		boolean actual = myList.isEmpty();
		assertEquals("List is indicated as empty when it's not ",
							expected,actual);
	}
	...
	public void testIterator()
	{
		...
		int actual = value.intValue();
		assertEquals("Iterator has returned the correct value ",
							expected,actual);
		assertEquals("Size was not updated correctly ", 5,myList.size());
	}
	...
	public void testSet_ForNullPointerException()
	{
		...
		try
		{
			...
			fail("Set method failed to throw NullPointerException correctly.");
		}
		catch (NullPointerException e)
		{
			assertTrue(true);
